...
不想安装任何东西？可以通过 [Socialistic](https://socialistic.ai) 平台直接在浏览器中体验 PersonaLingo 的 install-only skill 流程：

[![在线体验 PersonaLingo Skill](https://socialistic.ai/api/embed/personalingo-0d0e69?lang=en)](https://socialistic.ai/en/skill/personalingo-0d0e69?utm_source=github&utm_medium=readme&utm_campaign=personalingo)

运行的是与本地安装相同的 Agent 驱动流程（问卷 → 蒸馏 → 语料库生成），无需本地 Agent 环境或 API 密钥。由 [@shesl-tinkerland](https://github.com/shesl-tinkerland) 贡献 ([#2](https://github.com/orzcls/PersonaLingo/issues/2))。
...
- 在线部署由 [@shesl-tinkerland](https://github.com/shesl-tinkerland) 通过 [Socialistic](https://socialistic.ai) 提供。
...
| 贡献者 | 贡献内容 |
|---|---|
| [@orzcls](https://github.com/orzcls) | 项目创建者 & 维护者 |
| [@shesl-tinkerland](https://github.com/shesl-tinkerland) | Socialistic 在线部署 ([#2](https://github.com/orzcls/PersonaLingo/issues/2)) |
