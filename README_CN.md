...
<table>
  <tr>
    <td><img src="docs/screenshots/v3_06_questionnaire_entry.png" width="400"/><br/><sub>用户画像问卷</sub></td>
    <td><img src="docs/screenshots/v3_09_mbti_grid_INTJ_selected.png" width="400"/><br/><sub>MBTI 性格类型选择</sub></td>
  </tr>
  <tr>
    <td><img src="docs/screenshots/v3_01_settings_overview.png" width="400"/><br/><sub>设置页面总览</sub></td>
    <td><img src="docs/screenshots/v3_02_settings_targetscore.png" width="400"/><br/><sub>目标分数配置</sub></td>
  </tr>
  <tr>
    <td><img src="docs/screenshots/v3_11_topics_filter_P1_active.png" width="400"/><br/><sub>话题浏览与筛选</sub></td>
    <td><img src="docs/screenshots/v3_12_topics_filter_upgraded.png" width="400"/><br/><sub>增强版话题探索</sub></td>
  </tr>
  <tr>
    <td><img src="docs/screenshots/v3_10_chat_extractor.png" width="400"/><br/><sub>AI 对话引擎</sub></td>
    <td><img src="docs/screenshots/v3_03_settings_language.png" width="400"/><br/><sub>多语言支持</sub></td>
  </tr>
</table>
...
PersonaLingo 将 AI Agent 技能导出为可移植的技能包。每个技能包包含：

- `Skill.md` — 个性化学习技能文档
- `corpus.json` — 生成的语料库数据
- `runtime_protocol.md` — 运行时协议规范
- `prompts/` — 提示词模板
