...
`corpus.json.skill_manifest.mode = "runnable-export"`；schema 与 Install-only 模式共用 `skills/personalingo/skill-assets/corpus-schema.json`。
...
|---|---|---|
| 入口 | `npx skills add orzcls/PersonaLingo --skill personalingo` | `git clone` + `docker-compose up` |
...
本仓库内置的示例包位于 `exports/runnable/`：

- `exports/runnable/smoke_c_0a0e63e4/`
- `exports/runnable/smoke_c_0fe070a1/`
